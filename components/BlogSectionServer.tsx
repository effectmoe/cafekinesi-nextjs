  ...
  const defaultBlogPosts = [
    {
      ...
      excerpt: "忙しい現代社会において、ほんの少しの時間でも心を落ち着かせることの大切さを改めて感じています。",
      date: "2024.12.15",
    ...
    },
    {
      ...
      excerpt: "朝の目覚めを心地よくするアロマの選び方をご紹介します。",
      date: "2024.12.08",
    ...
    },
    {
      ...
      excerpt: "日常生活の中に静寂な時間を取り入れるための空間デザインについて考えてみました。",
      date: "2024.12.01",
    ...
    },
    {
      ...
      image: blog4,
      title: "ヨガのポーズで心を整える",
      excerpt: "身体の緊張をほぐし、精神的な安定を得るための基本的なヨガポーズをご紹介します。",
      date: "2024.11.24",
    ...
    },
    {
      ...
      image: blog5,
      title: "癒しのマッサージ技法",
      excerpt: "自宅でできる簡単なセルフマッサージの方法をお伝えします。",
      date: "2024.11.17",
    ...
    },
    {
      ...
      excerpt: "旬の食材を使った栄養バランスの取れた食事について考えてみましょう。",
      date: "2024.11.10",
    ...
    },
    {
      ...
      excerpt: "小さなスペースでも楽しめる庭づくりのコツをご紹介します。",
      date: "2024.11.03",
    ...
    },
    {
      ...
      image: blog8,
      title: "自然由来のスキンケア習慣",
      excerpt: "化学的な成分に頼らない、自然な素材を使ったスキンケアの方法をお伝えします。",
      date: "2024.10.27",
    ...
    },
    {
      ...
      excerpt: "簡単にできる呼吸法を身につけることで、日常のストレスを効果的に解放することができます。",
      date: "2024.10.20",
