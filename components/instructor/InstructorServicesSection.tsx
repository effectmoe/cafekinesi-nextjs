import { Service } from '@/lib/types/instructor'
...
export default function InstructorServicesSection({ servicesSection }: ServicesSectionProps) {
  // デフォルト値
  const title = servicesSection?.title || '提供サービス'
