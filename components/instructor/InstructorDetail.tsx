      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        {(instructor.website || (instructor.socialLinks && instructor.socialLinks.length > 0)) && (
          <div className="mb-16">
            ...
            {instructor.website && (
              <div className="mb-6">
                <h3 className="text-sm font-semibold text-gray-700 mb-3">ウェブサイト</h3>
                <a
                  href={instructor.website}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center px-4 py-3 bg-white border border-gray-200 rounded-lg hover:shadow-md transition-shadow text-gray-900 hover:text-blue-600"
                >
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                  </svg>
                  <span className="text-sm">{instructor.website}</span>
            ...
            {instructor.socialLinks && instructor.socialLinks.length > 0 && (
              <div>
                <h3 className="text-sm font-semibold text-gray-700 mb-3">SNSリンク</h3>
                  ...
                  {instructor.socialLinks.map((social, index) => {
                    ...
                    return (
                      <a
                        ...
                        rel="noopener noreferrer"
                        className="inline-flex items-center px-4 py-3 bg-white border border-gray-200 rounded-lg hover:shadow-md transition-shadow text-gray-900 hover:text-blue-600"
                        title={getPlatformName(social.platform)}
                      >
                        {getSocialIcon(social.platform)}
                        <span className="ml-2 text-sm font-medium">{getPlatformName(social.platform)}</span>
                        <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                        </svg>
                      </a>
