    ...
    <div className="mb-8">
      ...
      <div className="flex flex-wrap items-start gap-2 sm:gap-3">
        ...
        >
          ...
          <span className="text-xs text-gray-600 group-hover:text-gray-900 transition-colors text-center">Twitter</span>
        </a>
        ...
        >
          ...
          <span className="text-xs text-gray-600 group-hover:text-gray-900 transition-colors text-center">Facebook</span>
        </a>
        ...
        >
          ...
          <span className="text-xs text-gray-600 group-hover:text-gray-900 transition-colors text-center">LINE</span>
        </a>
        ...
        >
          ...
          <span className="text-xs text-gray-600 group-hover:text-gray-900 transition-colors text-center">はてな</span>
        </a>
        ...
        >
          ...
          <span className="text-xs text-gray-600 group-hover:text-gray-900 transition-colors text-center">Pocket</span>
        </a>
        ...
        >
          ...
          <span className="text-xs text-gray-600 group-hover:text-gray-900 transition-colors text-center w-full">
            {copied ? "コピー済み" : "URLコピー"}
          </span>
        </button>
      </div>
