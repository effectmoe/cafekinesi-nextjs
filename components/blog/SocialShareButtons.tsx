  ...
  return (
    <div className="sticky top-4 space-y-3">
      ...
      <a
        ...
        className="flex items-center gap-3 p-3 bg-white border border-gray-200 rounded-lg hover:bg-[#1DA1F2] hover:border-[#1DA1F2] hover:text-white transition-all duration-200 group"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-3 p-3 bg-white border border-gray-200 rounded-lg hover:bg-[#1877F2] hover:border-[#1877F2] hover:text-white transition-all duration-200 group"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-3 p-3 bg-white border border-gray-200 rounded-lg hover:bg-[#00B900] hover:border-[#00B900] hover:text-white transition-all duration-200 group"
        aria-label="LINEでシェア"
      >
        <svg className="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-3 p-3 bg-white border border-gray-200 rounded-lg hover:bg-[#00A4DE] hover:border-[#00A4DE] hover:text-white transition-all duration-200 group"
      ...
      <button
        ...
        className="flex items-center gap-3 p-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-700 hover:border-gray-700 hover:text-white transition-all duration-200 group w-full"
        aria-label="URLをコピー"
      >
        {copied ? (
          <>
