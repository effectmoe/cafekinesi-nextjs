    ...
    <div className="mb-8">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <a
          ...
          className="inline-flex items-center justify-center w-10 h-10 bg-white border border-gray-200 rounded-lg hover:bg-[#1DA1F2] hover:border-[#1DA1F2] hover:text-white transition-all duration-200"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center w-10 h-10 bg-white border border-gray-200 rounded-lg hover:bg-[#1877F2] hover:border-[#1877F2] hover:text-white transition-all duration-200"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center w-10 h-10 bg-white border border-gray-200 rounded-lg hover:bg-[#00B900] hover:border-[#00B900] hover:text-white transition-all duration-200"
          aria-label="LINEでシェア"
          title="LINE"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center w-10 h-10 bg-white border border-gray-200 rounded-lg hover:bg-[#00A4DE] hover:border-[#00A4DE] hover:text-white transition-all duration-200"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center w-10 h-10 bg-white border border-gray-200 rounded-lg hover:bg-[#EF3F56] hover:border-[#EF3F56] hover:text-white transition-all duration-200"
        ...
        <button
          ...
          className="inline-flex items-center justify-center w-10 h-10 bg-white border border-gray-200 rounded-lg hover:bg-gray-700 hover:border-gray-700 hover:text-white transition-all duration-200"
          aria-label="URLをコピー"
