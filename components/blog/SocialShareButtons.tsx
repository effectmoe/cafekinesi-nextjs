  ...
  return (
    <div className="mb-8">
      ...
      <div className="flex flex-wrap items-start gap-3">
        ...
        >
          <div className="flex items-center justify-center w-12 h-12 bg-[#1DA1F2] text-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200">
        ...
        >
          <div className="flex items-center justify-center w-12 h-12 bg-[#1877F2] text-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          ...
          aria-label="LINEでシェア"
        >
          <div className="flex items-center justify-center w-12 h-12 bg-[#00B900] text-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        >
          <div className="flex items-center justify-center w-12 h-12 bg-[#00A4DE] text-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        >
          <div className="flex items-center justify-center w-12 h-12 bg-[#EF3F56] text-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          aria-label="URLをコピー"
        >
          <div className="flex items-center justify-center w-12 h-12 bg-gray-700 text-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200">
            {copied ? (
